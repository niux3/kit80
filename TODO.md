...
- [x] test unitaire ui-selector
- [x] test unitaire ui-toggle
...
- [x] améliorer le routing. Il y a des routes ambiguës comme /:lang vs /about (insérer des paramètres). Voir discussion plus bas : évolution du routing
- [x] jsdoc
- [x] créer http referer
- [ ] la documentation (comment fonctionne ce truc -> ce sera même le build )
- [x] BUG ! Lors du build l'ajax sur un fichier json ne fonctione pas. Les pages renvoient erreur 500 !
- [x] darkmode
